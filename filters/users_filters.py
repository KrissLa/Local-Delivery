...
class HasNoLocation(BoundFilter):
    async def check(self, message: types.Message):
        """
        Пользователи, у которых не установлена локация
        """
...
class HasNoLocalObject(BoundFilter):
    async def check(self, message: types.Message):
        """
        Пользователи, у которых не установлен локальный объект доставки
        """
...
class HasNoMetro(BoundFilter):
    async def check(self, message: types.Message):
        """
        Пользователи, у которых не установлена ветка метро
        """
...
class SellerAdminHasLocationMessage(BoundFilter):
    async def check(self, message: types.Message):
        """
        Проверка на продовца-админа, который привязан к локации в сообщении
        """
